...
结果为
```java
2016-09-08T12:10:23.582 Car run
2016-09-08T12:10:24.584 Car Stop
Network join
2016-09-08T12:10:24.584 Dog run
2016-09-08T12:10:25.584 Dog stop
Main
```
当`carThread`join的时候, main线程就被挂起了, 然后`dogThread`join的时候,main线程也被挂起了.
