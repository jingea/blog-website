...
在上面的配置中我们直接在8090端口监听了一个http服务我们可以直接使用`http://localhost:8090/`进行请求访问.

如果我们在`/usr/local/Cellar/nginx/1.6.2/html/`下放置一个`txt.md`文件, 那么我们就可以使用Get请求`http://localhost:8090/txt.md`对其下载.
